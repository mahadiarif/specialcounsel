...
(function (factory) {
	...
	$.extend(Plugin.prototype, {
		...
		_construct: function(){
			...
			var autoCompleteText=this.getPlaceholder();
			autoCompleteText=$.trim(autoCompleteText);
			autoCompleteText=autoCompleteText.replace(' ','-');
			autoCompleteText='new'+autoCompleteText;
			this.$input = $('<input type="text"' + (isMobile? 'tabindex="-1"': '') + ' placeholder="'+ this.getPlaceholder() +'" class="'+ this.settings.inputClass + '" autocomplete="'+autoCompleteText+'">').appendTo(this.$container)
